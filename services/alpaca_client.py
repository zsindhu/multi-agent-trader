"""
Alpaca Client — Async brokerage API wrapper for options trading.
Uses alpaca-py (modern SDK) for orders, positions, options chains, and market data.
"""
import asyncio
...
class AlpacaClient:
    """Async wrapper around Alpaca's Trading + Data APIs for options trading."""
